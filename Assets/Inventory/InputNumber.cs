    ...
    IEnumerator DropItemCorountine(int _num)
    {
        for (int i = 0; i < _num; i++)
        {
            Instantiate(DragSlot.instance.dragSlot.item.itemPrefab,
                thePlayer.transform.GetChild(3).position,
                Quaternion.Euler(DragSlot.instance.dragSlot.item.itemPrefab.transform.rotation.x, DragSlot.instance.dragSlot.item.itemPrefab.transform.rotation.y, DragSlot.instance.dragSlot.item.itemPrefab.transform.rotation.z));
